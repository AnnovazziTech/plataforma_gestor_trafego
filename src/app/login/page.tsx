        ...
        >
          ...
          >
            ...
            >
              ...
              <span style={{ fontSize: '13px', color: '#6B6B7B' }}>credenciais demo</span>
              <div style={{ flex: 1, height: '1px', background: '#2A2A3A' }} />
            </div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '6px' }}>
                      <span style={{ fontSize: '13px', color: '#6B6B7B' }}>Email:</span>
                      <code
                        style={{
                          fontSize: '13px',
                          color: '#00F5FF',
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      <span style={{ fontSize: '13px', color: '#6B6B7B' }}>Senha:</span>
                      <code
                        style={{
                          fontSize: '13px',
                          color: '#00F5FF',
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background = '#BF00FF'
