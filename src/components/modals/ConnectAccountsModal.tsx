      ...
      {isConnectAccountsModalOpen && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-2xl bg-gradient-to-br from-[#12121A] to-[#0D0D14] border border-white/10 rounded-2xl shadow-2xl overflow-hidden"
          >
            {/* Header */}
            <div className="flex items-center justify-between p-6 border-b border-white/10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-white">Conectar Contas</h2>
                  <p className="text-sm text-[#6B6B7B]">Conecte suas plataformas de anúncios para importar dados</p>
                </div>
              </div>
              <button
                onClick={() => setIsConnectAccountsModalOpen(false)}
